...
% Calcul de l'arbre
taille_minimale_feuille = 4;
arbre = entrainement_arbre(X_app, Y_app, taille_minimale_feuille); % FONCTION A CODER
% Classification des donnees d'apprentissage
Y_app_pred = classification_arbre(arbre,X_app); % FONCTION A CODER
...
Y_test_pred = classification_arbre(arbre,X_test); % FONCTION A CODER
...
Y_pred_grille = classification_arbre(arbre,X_grille); % FONCTION A CODER
...
figure('Name','Classification par arbre de decision (apprentissage)',...
...
figure('Name','Classification par arbre de decision (test)',...
