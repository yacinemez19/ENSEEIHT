...
plot3(X_chrysanthemes(:,1),X_chrysanthemes(:,2),X_chrysanthemes(:,3),'m+','MarkerSize',15,'LineWidth',3);
axis xy;
grid on;
azimuth = -72;
elevation = 42;
