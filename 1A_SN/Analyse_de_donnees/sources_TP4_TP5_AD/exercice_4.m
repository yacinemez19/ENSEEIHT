...
[X_VS,Y_VS,Alpha_VS,c,code_retour] = estim_param_SVM_noyau_marge(X_app,Y_app,sigma,lambda); % FONCTION A CODER
% Classification des donnees d'apprentissage
Y_app_pred = classification_SVM_avec_noyau(X_app,sigma,X_VS,Y_VS,Alpha_VS,c); % FONCTION A CODER
...
Y_test_pred = classification_SVM_avec_noyau(X_test,sigma,X_VS,Y_VS,Alpha_VS,c); % FONCTION A CODER
...
Y_pred_grille = classification_SVM_avec_noyau(X_grille,sigma,X_VS,Y_VS,Alpha_VS,c); % FONCTION A CODER
